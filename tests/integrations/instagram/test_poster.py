...
Tests all functionality of the src/integrations/instagram/poster.py module including:
...
class TestPosterModule(unittest.TestCase):
    ...
    @patch('src.integrations.instagram.poster.POST_COMMENT', False)
    ...
    @patch('src.integrations.instagram.poster.POST_COMMENT', True)
    @patch('src.integrations.instagram.poster.submit_comment')
    @patch('src.integrations.instagram.poster.find_and_focus_comment_input')
    @patch('src.integrations.instagram.poster.time.sleep')
    ...
    @patch('src.integrations.instagram.poster.verify_comment_posted')
